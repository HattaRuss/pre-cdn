...
const routes = [
    {
        ...
        children: [
            ...
            {
                path: 'dashboard',
                loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e(0), __webpack_require__.e(3)]).then(__webpack_require__.bind(null, /*! ./dashboard/dashboard.module */ "./src/app/imodule/admin/dashboard/dashboard.module.ts")).then(m => m.DashboardModule),
                canActivate: [_shared_guard_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]]
            }
        ]
    }
...
let TopnavComponent = class TopnavComponent {
    constructor(router, translate, AuthService) {
        this.router = router;
        this.translate = translate;
        this.AuthService = AuthService;
